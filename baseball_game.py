...
def is_between_100_and_999(user_input_number):
    ...
    # ===Modify codes below=============
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    result = 100 <= int(user_input_number) and int(user_input_number) < 1000
    # ==================================
    return result
...
def is_duplicated_number(three_digit):
    ...
    # ===Modify codes below=============
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    result = any([three_digit.count(x) > 1 for x in three_digit])
    # ==================================
    return result
...
def get_not_duplicated_three_digit_number():
    ...
    for i, d in enumerate(result):
        ...
        if x in deck:
            ...
            idx_random_in_deck = random.randrange(0, len(deck))
            new_digit = deck[idx_random_in_deck]
            result = result[:i] + str(new_digit) + result[i + 1:]
            deck.remove(new_digit)
    # ==================================
    return int(result)
...
def get_strikes_or_ball(user_input_number, random_number):
    ...
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    result = [0, 0]
    for i, x in enumerate(user_input_number):
        if x == random_number[i]:
            result[0] += 1
...
def is_yes(one_more_input):
    ...
    # ===Modify codes below=============
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    result = str(one_more_input).lower() in ["y", "yes"]
    # ==================================
    return result
...
def is_no(one_more_input):
    ...
    # ===Modify codes below=============
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    result = str(one_more_input).lower() in ["n", "no"]
    # ==================================
    return result
...
def main():
    ...
    while is_game_running:
        ...
        if int(strikes) == 3:
            is_game_again = None
            while is_game_again is None:
                is_game_again = input("You win, one more(Y/N)? ")
                if is_yes(is_game_again):
                    is_game_again = True
                    continue
                elif is_no(is_game_again):
                    is_game_again = False
                    break
                else:
                    print("Wrong Input")
                    is_game_again = None
            if is_game_again is False:
